...
model_checkpoint = ModelCheckpoint(
    filepath=os.path.join(models_dir, 'rec_bl_Inception_BM.keras'),
    save_best_only=True,
    monitor='val_loss',
    mode='min'
)
...
# 학습이 완료된 후 모델 저장
model.save(os.path.join(models_dir, 'rec_bl_Inception.keras'))

with open(os.path.join(models_dir, 'rec_bl_Inception.pkl'), 'wb') as file:
